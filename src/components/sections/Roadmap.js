      ...
      <Container>
        ...
        <Items>
          ...
          <RoadMapItem
            addToRef={addToRefs}
            title="Grand Opening"
            subtext="Twitter and Discord Launch to public."
          />
         
          <RoadMapItem
            addToRef={addToRefs}
            title="Early Access"
            subtext="Gain exclusive early access to our server and secure your place within our community. "
          />
           <RoadMapItem
            addToRef={addToRefs}
            title="Great Benefits"
            subtext="Each family name will be entitled to a percentage of the net income generated by the project's resources."
          />
          <RoadMapItem
            addToRef={addToRefs}
            title="NFT Ranking"
